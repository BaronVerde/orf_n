...
public:
	...
	const orf_n::dAABB *getBoundingBox() const;

	const omath::vec2 &getMinMaxHeight() const;

    void create( const float x, const float z, const float size, const int level, const orf_n::dAABB *const wholeMapBB,
...
private:
    ...
    const orf_n::dAABB *m_boundingBox{ nullptr };
